...
if (do_authentication):
  login=opener.open("https://rda.ucar.edu/cgi-bin/login","email=juniorphy@gmail.com&password="+sys.argv[1]+"&action=login")
#
...
listoffiles=[sys.argv[4]+"/"+"cdas1."+sys.argv[2]+".sfluxgrbf.tar"]
